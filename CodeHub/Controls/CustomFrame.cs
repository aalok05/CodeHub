...
namespace CodeHub.Controls
{
    ...
    public class CustomFrame : Frame
    {
        ...
        /// </summary>
        private const int ContentAnimationDuration = 160;
        ...
        {
            return FrameworkContent.StartCompositionFadeScaleAnimationAsync(1, 0, 1, 1.02f, ContentAnimationDuration, null, 0, EasingFunctionNames.SineEaseInOut);
        }
        ...
        {
            return FrameworkContent.StartCompositionFadeScaleAnimationAsync(0, 1, 0.98f, 1, ContentAnimationDuration, null, 0, EasingFunctionNames.SineEaseInOut);
        }
        ...
        {
            return FrameworkContent.StartCompositionFadeScaleAnimationAsync(1, 0, 1, 0.98f, ContentAnimationDuration, null, 0, EasingFunctionNames.SineEaseInOut);
        }
        ...
        {
            return FrameworkContent.StartCompositionFadeScaleAnimationAsync(0, 1, 1.02f, 1, ContentAnimationDuration, null, 0, EasingFunctionNames.SineEaseInOut);
        }
