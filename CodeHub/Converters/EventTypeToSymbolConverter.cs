...
namespace CodeHub.Converters
{
    class EventTypeToSymbolConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            if ( (string)value == "ForkEvent" || (string)value == "ForkApplyEvent")
            {
            ...
            else if((string)value == "PullRequestEvent")
            {
            ...
            else if ((string)value == "IssueCommentEvent" || (string)value == "PullRequestReviewCommentEvent" || (string)value == "CommitCommentEvent")
            {
            ...
            else if((string)value == "IssuesEvent")
            {
            ...
            {
                var watchSymbol = "<Geometry xmlns=\"http://schemas.microsoft.com/winfx/2006/xaml/presentation\">M8.06 2C3 2 0 8 0 8s3 6 8.06 6C13 14 16 8 16 8s-3-6-7.94-6zM8 12c-2.2 0-4-1.78-4-4 0-2.2 1.8-4 4-4 2.22 0 4 1.8 4 4 0 2.22-1.78 4-4 4zm2-4c0 1.11-.89 2-2 2-1.11 0-2-.89-2-2 0-1.11.89-2 2-2 1.11 0 2 .89 2 2z</Geometry>";
                return (Geometry)XamlReader.Load(watchSymbol);
            }
            else if((string)value == "RepositoryEvent")
            {
                ...
                return (Geometry)XamlReader.Load(repoSymbol);
            }
            else if ((string)value == "FollowEvent")
            {
                ...
                return (Geometry)XamlReader.Load(profileSymbol);
            }
            else
            {
