...
namespace BackgroundTasks.Helpers
{
	...
	{
		private static readonly IPropertySet currentSettings = ApplicationData.Current.LocalSettings.CreateContainer("Settings", ApplicationDataCreateDisposition.Always).Values;
